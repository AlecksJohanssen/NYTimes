...
public class BookSearchActivity extends AppCompatActivity {
    ...
    EditText etbookQuery;
    GridView gvResultsBook;
    Button btnsearch;
    ...
    {
        etbookQuery = (EditText) findViewById(R.id.etQuery);
        gvResultsBook = (GridView) findViewById(R.id.gvResult);
        btnsearch = (Button) findViewById(R.id.btnSearch);
        articles = new ArrayList<>();
        adapter = new ArticleArrayAdapter(this, articles);
        gvResultsBook.setAdapter(adapter);
        gvResultsBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
